...
from data import PredDataset_hidden, normalize_data_hidden, scaling_back
...
if __name__ == '__main__':
    ...
    for i in range(args.ensemble_size):
        ...
        # normalize data
        test_scaled, _ = normalize_data_hidden(df, rxn_id_column, scalers=scaler, target_column=args.target_column)
