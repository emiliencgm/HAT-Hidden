...
from run.predict_hidden import predict_hidden
...
def make_predictions_hidden(args: Namespace, smiles: List[str] = None) -> List[Optional[List[float]]]:
    """
    ...
    test_preds_hidden, test_smiles_batch = predict_hidden(
        model=model,
        data=test_data,
    ...
    return test_preds_hidden, test_smiles_batch